window.initGRPCForm = function(services, svcDescs, mtdDescs, invokeURI, metadataURI, debug, headers) {
    ...
    function formServiceSelected(callback_success, callback_failure) {
        ...
        formMethodSelected(callback_success, callback_failure);
        */
        callback_success?.();
    }
    window.formServiceSelectedWithPromise = () => {
        return new Promise((resolve, reject) => {
            formServiceSelected(() => resolve(), () => reject())
        });
    }

    function formMethodSelected(callback_success, callback_failure) {
    ...
    window.formMethodSelectedWithPromise = () => {
        return new Promise((resolve, reject) => {
            formMethodSelected(() => resolve(), () => reject())
        });
    }
    ...
    function invoke(customData, customMetadata, callback_success, callback_failure) {
        var service = $("#grpc-service").val();
        var method = $("#grpc-method").val();
        ...
        var metadata;
        if (typeof(customMetadata) !== "undefined") {
    ...
    function renderResponse(durationMs, responseData) {

...
/**
 * Generated from protobuf message <code>services.fileio.GetUsersQuotaEntriesRequest</code>
 */
class GetUsersQuotaEntriesRequest extends \Google\Protobuf\Internal\Message
{
    /**

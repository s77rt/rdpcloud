...
const E_FILE_NOT_FOUND = 0x80070002
const E_PATH_NOT_FOUND = 0x80070003
const E_NOT_SUPPORTED = 0x80070032
const E_FILE_EXISTS = 0x80070050
const E_PATH_TOO_LONG = 0x8007006F
const E_INVALID_NAME = 0x8007007B
